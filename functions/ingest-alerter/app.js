...
exports.lambdaHandler = async (event, context) => {
    return new Promise((resolve, reject) => {
        ...
        var host = "https://publications.europa.eu";
        const url = `${host}/webapi/notification/ingestion?startDate=${startDate}&endDate=${endDate}&type=CREATE&wemiClasses=work`
        console.log('Querying publications: %s', url)
        const params = {
            method: 'get',
            url: url,
            headers: {
